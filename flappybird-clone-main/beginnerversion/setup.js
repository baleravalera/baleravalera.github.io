...
// menu text variables
const menuFirstText = "Press " + startKey + " to start the game";
const menuTextXPosition = 300;
const menuTextYPosition = 400; 
const menuSecondText = "Press space to fly as a unicorn";
const menuTextSize = 60;
const menuTextColor = "rgb(255, 107, 164)";
const gameOverText = "Press " + restartKey + " to restart the game";

// diamond variables
const diamondSound = new Audio("../assets/sounds/diamond.wav");
...
// heart variables
const heartSound = new Audio("../assets/sounds/heart.wav");
